...
//     },[mode])
  ...
  return(
<>
<strong className='warningnav'>W A R N I N G : Do not Navigate away from this page while keeping track of Victory Points because it will reload and reset the counters</strong>
